module.exports = {
	...
	/*
	* Loop over characters in a string and run a callback function on each character
	* Use:
	* 	utils.forEachCharacter("string", function(iteration, character));
	*/
	...
	md5 : function() {
		...
		* Altered to provide a friendly object interface
		* Use:
